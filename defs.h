...
void initEscape(EscapeType *); // done                                                  //COMPLETE

/* prints out and sends to client the outcome of the escape */
void handleEscapeResult(EscapeType *); // done                                          //COMPLETE
...
void moveFlyer(FlyerType *, EscapeType *); // done                                        //COMPLETE
...
void computeHeroDir(EscapeType *, FlyerType *, int *); // done                             //COMPLETE

/* determines if a flyer has reached the ground */
int flyerIsDone(FlyerType *); // done                                                   //COMPLETE
...
HeroType *checkForCollision(PositionType *, EscapeType *); // done                        //COMPLETE

/* top-level function for serializing hollow, printing and sending it
   to client */
void outputHollow(EscapeType *); // done                                                 //COMPLETE

/* initializes 2D grid with participant avatars in current positions */
void initHollow(EscapeType *, char[][MAX_COL]); // COMPLETE
